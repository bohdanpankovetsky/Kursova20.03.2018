...
""));
        ...
        QWidget::setTabOrder(polomka1, polomka2);
        QWidget::setTabOrder(polomka2, polomka3);
        QWidget::setTabOrder(polomka3, polomka4);
        QWidget::setTabOrder(polomka4, tech_obsl1);
        QWidget::setTabOrder(tech_obsl1, tech_obsl2);
        QWidget::setTabOrder(tech_obsl2, tech_obsl3);
        QWidget::setTabOrder(tech_obsl3, vartist_robit);
        QWidget::setTabOrder(vartist_robit, pushButton_3);
